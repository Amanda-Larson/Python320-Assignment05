...
class TestMongoDBConnection(TestCase):
    ...
    def load_tables(self):
        """load tables"""
        mongo = TestMongoDBConnection()
        with mongo:
            db = mongo.connection.media

            # collection in database
            test_user_accounts = db["test_user_accounts"]
            test_status_accounts = db["TestStatusAccounts"]
            ...
            self.assertEqual(test_user_accounts.add_user(user_id, user_email,
                                                         user_name, user_last_name), True)

            # Create default status
            user_id = 'ldconejo79'
            status_id = 'ldconejo79_001'
            status_text = 'My first status'
            self.assertEqual(test_status_accounts.add_status(user_id,
                                                           status_id, status_text), True)
    ...
    def test_add_user(self):
        ...
        with mongo:
            ...
            db = mongo.connection.media
            # collection in database
            test_user_accounts = db["TestUserAccounts"]
            user_id = 'ldconejo80'
            user_name = 'Luis'
            user_last_name = 'Conejo'
            user_email = 'luisconejo@conejo.com'
    ...
    def test_add_user_duplicated(self):
        ...
        with self.mongo:
            ...
            user_email = 'luisconejo@conejo.com'
            self.assertEqual(test_user_accounts.add_user(user_id, user_email,
                                                       user_name, user_last_name), False)
    ...
    def test_modify_user(self):
        ...
        with self.mongo:
            ...
            self.assertEqual(test_user_accounts.modify_user(user_id, user_email,
                                                          user_name, user_last_name), True)
    ...
    def test_search_user(self):
        with self.mongo:
            ...
            user_last_name = 'Conejo'
            user_email = 'luisconejo@conejo.com'
            result = test_user_accounts.search_user(user_id)
    ...
    def test_delete_user(self):
        with self.mongo:
            ...
            user_id = 'ldconejo79'
            self.assertEqual(TestUserAccounts.delete_user(user_id), True)
    ...
    def test_delete_user_not_found(self):
        with self.mongo:
            ...
            TestUserAccounts = db["TestUserAccounts"]
            user_id = 'joemissing'
            self.assertEqual(TestUserAccounts.delete_user(user_id), False)
    ...
    def test_add_status(self):
        ...
        status_text = 'My first status'
        self.assertEqual(TestStatusAccounts.add_status(user_id, status_id,
                                                       status_text), True)
    ...
    def test_add_duplicated(self):
        ...
        status_id = 'ldconejo79_001'
        status_text = 'My first status'
        self.assertEqual(self.status_collection.add_status(user_id, status_id,
                                                           status_text), False)
    ...
    def test_modify_status(self):
        ...
        self.assertEqual(self.status_collection.modify_status(status_id, user_id,
                                                              status_text), True)
